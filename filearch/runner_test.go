...
func TestRunGeneratedFileSelection(t *testing.T) {
	dir := t.TempDir()
	writeFile(t, dir, "go.mod", "module example.com/generated\n\ngo 1.26\n")
	writeFile(t, dir, ".architecture.yaml", `
version: 1
fileContractRules:
  - id: handwritten-aliases
    files:
      include: ["**/*.go"]
      generated: false
    deny:
      declarations:
        - kind: alias
    message: handwritten aliases are denied
`)
	writeFile(t, dir, "handwritten.go", "package generated\ntype Handwritten = string\n")
	writeFile(t, dir, "generated.go", "// Code generated by fixture. DO NOT EDIT.\npackage generated\ntype Generated = string\n")
	writeFile(t, dir, "misplaced.go", "package generated\n// Code generated by fixture. DO NOT EDIT.\ntype Misplaced = string\n")
	...
	got := err.Error()
	for _, want := range []string{"2 architecture violation(s):", "Handwritten", "Misplaced"} {
		if !strings.Contains(got, want) {
			t.Fatalf("Run() error = %v, want %q", err, want)
		}
	}
	if strings.Contains(got, `Generated`) {
		t.Fatalf("Run() error = %v, generated alias should be exempt", err)
	}
}
